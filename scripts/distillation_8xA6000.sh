...
torchrun --nnodes=1 --nproc_per_node=8 --master_port=29501 \
    ...
    experiment=Mar23_dagger_mobile_full-tablemulti_mobileobs0_Mar23_8x1024_curridr200k_local_t_auxdelta_2048_0_1024_expFeb23