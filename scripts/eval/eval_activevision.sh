...
task=DexMobileExpFull num_envs=500 seed=1 multi_gpu=True \
teacher.ckpt="./rl_ckpts/exp_shelf_May6.pth" \
task.env.mesh.mesh_dir="./meshes_final/default" \
task.cfg_override="SideConstrained" experiment=shelf_noactivecamera \
...
eval.ckpt_path=dagger_ckpts/grogu_ckpts/May20_wbc_8x512_shelf_top_table_newfabric_noactivecamera_ep380.pt \
...
task.env.mesh.mesh_dir="./meshes_final/default" \
task.cfg_override="TopdownConstrained" experiment=box_noactivecamera \
task.env.object_wrench.enable=False task.env.object_teleport.enable=False \
task.env.scene.batch_idx=0 \
model=transformer_mobile_local_t_auxdelta \
eval.debug_visuals=False \
...
teacher.ckpt="./rl_ckpts/exp_top_Apr9.pth" \
task.env.mesh.mesh_dir="./meshes_final/default" \
task.cfg_override="TopdownConstrained" experiment=drawer_noactivecamera \
task.env.object_wrench.enable=False task.env.object_teleport.enable=False \
...
teacher.ckpt="./rl_ckpts/exp_top_Apr9.pth" \
task.env.mesh.mesh_dir="./meshes_final/default" \
task.cfg_override="TopdownConstrained" experiment=tabletop_noactivecamera \
task.env.object_wrench.enable=False task.env.object_teleport.enable=False \
